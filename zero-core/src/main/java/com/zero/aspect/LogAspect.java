...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.zero.common.annotation.Log)")
    ...
    public void doAfterReturning(JoinPoint joinPoint) {
        log.info("=========== AfterReturning:"+ joinPoint.toString());
//        handleLog(joinPoint, null);
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Exception e) {
        log.info("=========== AfterThrowing:"+ joinPoint.toString());
...
//                return;
//            }
//            System.out.println("拦截到了日志"+ e.getMessage());
//
//            // 获取当前的用户
