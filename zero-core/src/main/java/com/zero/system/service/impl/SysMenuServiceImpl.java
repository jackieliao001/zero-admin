...
import com.zero.common.base.domain.entity.SysRole;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            if (!cMenus.isEmpty() && cMenus.size() > 0 && UserConstants.TYPE_DIR.equals(menu.getMenuType())) {
                ...
                children.setName(StringUtils.convertToCamelCase(menu.getPath()));
                ...
                children.setName(StringUtils.convertToCamelCase(routerPath));
    ...
    public List<TreeNode> buildMenuTreeSelect(List<SysMenu> menus) {
        ...
        return menuTrees.stream().map(TreeNode::new).collect(Collectors.toList());
    }
    ...
    public String getRouteName(SysMenu menu) {
        String routerName = StringUtils.convertToCamelCase(menu.getPath());
        // 非外链并且是一级目录（类型为目录）
        if (isMenuFrame(menu)) {
